...
def _debug_verify_qmm_enabled() -> bool:
    return _os.environ.get("MTPLX_VERIFY_QMM", "1") == "1"


def _debug_verify_qmm_variant() -> str:
    return _os.environ.get("MTPLX_VERIFY_QMM_VARIANT", "auto")


def _debug_verify_qmm_kparts(default: int) -> int:
    try:
        return int(_os.environ.get("MTPLX_VERIFY_QMM_KPARTS", str(default)))
    except ValueError:
        return default
